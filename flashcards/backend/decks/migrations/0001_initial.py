# Generated by Django 4.2 on 2023-05-03 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("decks", models.ManyToManyField(blank=True, related_name="tags", to="decks.deck")),
                ("flashcards", models.ManyToManyField(blank=True, related_name="tags", to="decks.flashcard")),
            ],
            options={
                "verbose_name": "tag",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="decks.difficultylevel"),
        ),
